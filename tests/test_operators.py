...
def test_sigmoid(a):
    ...
    * it is  strictly increasing.
    ...
    # prove the derivative of sigmoid is strictly > 0 - I can't
    # I can only test if it is greater than or equal to zero due to floating point roundoff at large
...
@pytest.mark.task0_2
@given(small_floats, small_floats, small_floats)
def test_associative(z, x, y):
    """
    Write a test that ensures the associative property holds for your functions, i.e.
...
def test_sum_distribute(ls1, ls2):
    ...
    assert sum(ls1) + sum(ls2) == sum([a + b for a, b in zip(ls1, ls2)])
